...
Ensimmäinen varsinainen hakkeritehtävä oli selvittää, mikä palvelu ja sen versio on kohdekoneen portissa 80. Skannasin tutulla komennolla ``sudo nmap -A -T4``, ja portista 80 löytyi Apache.
...
Sitten keksin mennä siihen osoitteeseen selaimella, koska olinhan samassa verkossa. Siellä näkyi login-sivu.
